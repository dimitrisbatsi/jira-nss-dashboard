...
$tempTrigger1 = New-ScheduledTaskTrigger -Once -At 9:00am -RepetitionInterval (New-TimeSpan -Minutes 15) -RepetitionDuration (New-TimeSpan -Hours 9)
$trigger1.Repetition = $tempTrigger1.Repetition
...
$tempTrigger2 = New-ScheduledTaskTrigger -Once -At 6:00pm -RepetitionInterval (New-TimeSpan -Hours 1) -RepetitionDuration (New-TimeSpan -Hours 6)
$trigger2.Repetition = $tempTrigger2.Repetition
...
Register-ScheduledTask -TaskName "NSS_Timesheet_Sync_Full_Weekend" `
    ...
    -Action $actionFull `
    -Settings $settings `
    -Description "Runs full sync (Truncate and Reload) from Jira to SQL Server at 6 AM on Saturdays and Sundays." `
    -Force | Out-Null
