...
def show_classmarker_questions(can_edit, can_manage):
    ...
    with col_imp:
        with st.popover("ℹ️ Οδηγίες Γραμμογράφησης Excel", use_container_width=True):
            ...
            #### 🔒 Υποχρεωτικές Στήλες
            * **`QuestionID`**: Ο μοναδικός αναγνωριστικός αριθμός της ερώτησης (ακέραιος). *Αφήστε το κενό για να προστεθεί ως νέα ερώτηση.*
            ...
            * **`multiplechoice`**: Πολλαπλής Επιλογής - Μονής Σωστής Απάντησης.
            * **`truefalse`**: Σωστό / Λάθος.
            * **`freetext`**: Ελεύθερο Κείμενο / Ανάπτυξης.
            * **`essay`**: Έκθεση / Δοκίμιο.
            * **`multipleresponse`**: Πολλαπλής Απόκρισης - Πολλαπλών Σωστών Απαντήσεων.
